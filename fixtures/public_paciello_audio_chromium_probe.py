#!/usr/bin/env python3
"""Real Chromium + Paciello audio public-player media initiation proof.
...
def main() -> int:
    root = Path(tempfile.mkdtemp(prefix="dm-paciello-audio-chromium-"))
    home = root / "home"
    ...
    try:
        ...
        media_name = "paciello-audio" + suffix
